  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-xl leading-none"
                  style={{
                ...
                >
                  <social.Icon size={18} strokeWidth={2} className="block shrink-0" />
                </a>
              ))}
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div 
          className="pt-8 border-t border-white/20 flex flex-col items-center gap-4 text-center"
        >
          <p 
