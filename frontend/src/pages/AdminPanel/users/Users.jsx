...
const Users = () => {
  ...
  return (
    <div className="min-h-screen bg-bg flex justify-center items-start py-8 animate-fade-in">
      <div className="w-11/12 sm:w-4/5 p-6 rounded-xl shadow-lg border border-border-color bg-accent">
                    ...
                    return (
                      <>
                        <tr
                          ...
                          className="border-b border-border-color hover:bg-accent cursor-pointer"
